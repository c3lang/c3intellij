...
public class C3FuncHeaderImpl extends ASTWrapperPsiElement implements C3FuncHeader {

  public C3FuncHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C3Visitor visitor) {
    visitor.visitFuncHeader(this);
  }
