...
public class C3TypedefDeclarationImpl extends ASTWrapperPsiElement implements C3TypedefDeclaration {

  public C3TypedefDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public C3TypedefType getTypedefType() {
    return findNotNullChildByClass(C3TypedefType.class);
  }
