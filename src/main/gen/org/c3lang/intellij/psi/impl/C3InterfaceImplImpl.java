...
public class C3InterfaceImplImpl extends ASTWrapperPsiElement implements C3InterfaceImpl {

  public C3InterfaceImplImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull C3Visitor visitor) {
    visitor.visitInterfaceImpl(this);
  }
