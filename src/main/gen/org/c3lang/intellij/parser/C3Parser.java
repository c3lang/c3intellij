...
public class C3Parser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(ASM_EXPR, ASSIGN_TYPE_EXPR, ATTRIBUTE_OPERATOR_EXPR, BINARY_EXPR,
      ...
      CT_CALL_EXPR, CT_COND_EXPR, CT_DEFINED_CHECK_EXPR, CT_DEFINED_EXPR,
      CT_FEATURE_EXPR, DECL_OR_EXPR, EXPR, EXPR_BLOCK_EXPR,
      GROUPED_EXPR, INIT_LIST_EXPR, KEYWORD_EXPR, LAMBDA_DECL_EXPR,
      LAMBDA_DECL_SHORT_EXPR, LITERAL_EXPR, LOCAL_IDENT_EXPR, OPTIONAL_EXPR,
      PATH_AT_IDENT_EXPR, PATH_CONST_EXPR, PATH_IDENT_EXPR, STRING_EXPR,
      TERNARY_EXPR, TYPE_ACCESS_EXPR, UNARY_EXPR),
  };
  ...
  // generic_parameters?
  private static boolean base_type_11_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "base_type_11_2")) return false;
  ...
  public static boolean bitstruct_declaration(PsiBuilder b, int l) {
    ...
    r = r && type_name(b, l + 1);
    r = r && bitstruct_declaration_2(b, l + 1);
    r = r && consumeToken(b, COLON);
    r = r && type(b, l + 1);
    r = r && bitstruct_declaration_5(b, l + 1);
  ...
  // DOT access_ident
  private static boolean call_expr_tail_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "call_expr_tail_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  public static boolean const_decl(PsiBuilder b, int l) {
    ...
    r = r && const_decl_1(b, l + 1);
    r = r && consumeToken(b, CONST_IDENT);
    r = r && const_decl_3(b, l + 1);
    r = r && consumeToken(b, EQ);
    r = r && expr(b, l + 1, -1);
    r = r && consumeToken(b, EOS);
  ...
  // type?
  private static boolean const_decl_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "const_decl_1")) return false;
    type(b, l + 1);
    return true;
  }

  // attributes?
  private static boolean const_decl_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "const_decl_3")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // KW_CT_ERROR constant_expr EOS | KW_CT_ASSERT constant_expr (COLON constant_expr)? EOS
  public static boolean ct_assert_stmt(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_assert_stmt")) return false;
    if (!nextTokenIs(b, "<ct assert stmt>", KW_CT_ASSERT, KW_CT_ERROR)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CT_ASSERT_STMT, "<ct assert stmt>");
    r = ct_assert_stmt_0(b, l + 1);
    if (!r) r = ct_assert_stmt_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // KW_CT_ERROR constant_expr EOS
  private static boolean ct_assert_stmt_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_assert_stmt_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  private static boolean ct_assert_stmt_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_assert_stmt_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, KW_CT_ASSERT);
    r = r && constant_expr(b, l + 1);
    r = r && ct_assert_stmt_1_2(b, l + 1);
    r = r && consumeToken(b, EOS);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // (COLON constant_expr)?
  private static boolean ct_assert_stmt_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_assert_stmt_1_2")) return false;
    ct_assert_stmt_1_2_0(b, l + 1);
    return true;
  }

  // COLON constant_expr
  private static boolean ct_assert_stmt_1_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_assert_stmt_1_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // KW_CT_INCLUDE expr attributes? EOS
  ...
  /* ********************************************************** */
  // const_decl | local_decl_storage? optional_type decl_stmt_after_type EOS
  ...
  public static boolean def_decl(PsiBuilder b, int l) {
    ...
    r = r && any_ident(b, l + 1);
    r = r && def_decl_2(b, l + 1);
    r = r && consumeToken(b, EQ);
    r = r && def_declaration_source(b, l + 1);
    r = r && def_decl_5(b, l + 1);
    r = r && consumeToken(b, EOS);
    exit_section_(b, m, DEF_DECL, r);
    return r;
  }
  ...
  public static boolean distinct_declaration(PsiBuilder b, int l) {
    ...
    r = r && type_name(b, l + 1);
    r = r && distinct_declaration_2(b, l + 1);
    r = r && distinct_declaration_3(b, l + 1);
    r = r && consumeToken(b, "=");
    r = r && distinct_declaration_5(b, l + 1);
    r = r && type(b, l + 1);
    r = r && distinct_declaration_7(b, l + 1);
    r = r && consumeToken(b, EOS);
    exit_section_(b, m, DISTINCT_DECLARATION, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // CONST_IDENT attributes? (EQ expr)?
  ...
  private static boolean enum_constant_2(PsiBuilder b, int l) {
    ...
    enum_constant_2_0(b, l + 1);
    return true;
  }

  // EQ expr
  private static boolean enum_constant_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "enum_constant_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, EQ);
    r = r && expr(b, l + 1, -1);
  ...
  /* ********************************************************** */
  // enum_param_list | type enum_param_list?
  ...
  private static boolean enum_spec_1(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = type(b, l + 1);
    r = r && enum_spec_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // enum_param_list?
  private static boolean enum_spec_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "enum_spec_1_1")) return false;
  ...
  /* ********************************************************** */
  // KW_FAULT type_name interface_impl? attributes? LB CONST_IDENT (COMMA CONST_IDENT)* COMMA? RB
  ...
  private static boolean fault_declaration_6(PsiBuilder b, int l) {
    ...
    while (true) {
      int c = current_position_(b);
      if (!fault_declaration_6_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "fault_declaration_6", c)) break;
    }
    return true;
  }

  // COMMA CONST_IDENT
  private static boolean fault_declaration_6_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "fault_declaration_6_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // COMMA?
  private static boolean fault_declaration_7(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "fault_declaration_7")) return false;
    consumeToken(b, COMMA);
    return true;
  }
  ...
  /* ********************************************************** */
  // KW_MODULE path_ident (LGENPAR module_params RGENPAR)? attributes? EOS {
  // }
  ...
  public static boolean param_path_element(PsiBuilder b, int l) {
    ...
    if (!r) r = parseTokens(b, 0, DOT, CT_TYPE_IDENT);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // import_decl
  //     | KW_EXTERN? (func_definition | const_decl | global_decl)
  //     | ct_assert_stmt
  //     | ct_echo_stmt
  //     | ct_include_stmt
  //     | type_decl
  ...
  // func_definition | const_decl | global_decl
  private static boolean top_level_1_1(PsiBuilder b, int l) {
    ...
    if (!r) r = const_decl(b, l + 1);
    if (!r) r = global_decl(b, l + 1);
    return r;
  }

  // KW_ASM expr attributes? EOS
  private static boolean top_level_9(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_level_9")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, KW_ASM);
    r = r && expr(b, l + 1, -1);
    r = r && top_level_9_2(b, l + 1);
    r = r && consumeToken(b, EOS);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // attributes?
  private static boolean top_level_9_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_level_9_2")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  //    ATOM(lambda_decl_expr) PREFIX(lambda_decl_short_expr) ATOM(init_list_expr)
