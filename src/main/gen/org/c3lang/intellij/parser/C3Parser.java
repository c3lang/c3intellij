...
public class C3Parser implements PsiParser, LightPsiParser {
  ...
  public static boolean alias_decl(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, alias_decl_3(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, EQ)) && r;
    r = p && report_error_(b, alias_decl_5(b, l + 1)) && r;
  ...
  private static boolean alias_decl_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "alias_decl_5")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = alias_decl_5_0(b, l + 1);
    if (!r) r = alias_declaration_source(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // KW_MODULE module_path
  private static boolean alias_decl_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "alias_decl_5_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // attributes?
  private static boolean alias_type_decl_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "alias_type_decl_3")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  // ELLIPSIS?
  private static boolean arg_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arg_0_2_0")) return false;
  ...
  public static boolean asm_expr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, ASM_EXPR, "<asm expr>");
  ...
  public static boolean attrdef_decl(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, attrdef_decl_5(b, l + 1)) && r;
    r = p && consumeToken(b, EOS) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // (EQ def_attr_values)?
  private static boolean attrdef_decl_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "attrdef_decl_5")) return false;
    attrdef_decl_5_0(b, l + 1);
    return true;
  }

  // EQ def_attr_values
  private static boolean attrdef_decl_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "attrdef_decl_5_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, EQ);
  ...
  public static boolean attribute_operator_expr(PsiBuilder b, int l) {
    ...
    if (!r) r = attribute_operator_expr_15(b, l + 1);
  ...
  // STAR &RP
  private static boolean attribute_operator_expr_15(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "attribute_operator_expr_15")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, STAR);
    r = r && attribute_operator_expr_15_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // &RP
  private static boolean attribute_operator_expr_15_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "attribute_operator_expr_15_1")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = consumeToken(b, RP);
    exit_section_(b, l, m, r, false, null);
  ...
  private static boolean base_type_14(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, KW_CT_REFLECT);
    r = r && grouped_expr(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  public static boolean bitstruct_declaration(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, bitstruct_declaration_6(b, l + 1)) && r;
  ...
  // attributes?
  private static boolean bitstruct_declaration_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bitstruct_declaration_6")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  private static boolean call_expr_tail_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = call_expr_tail_1_0(b, l + 1);
    r = r && consumeToken(b, LBT);
    r = r && call_expr_tail_1_2(b, l + 1);
    r = r && consumeToken(b, RBT);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // DOT?
  private static boolean call_expr_tail_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "call_expr_tail_1_0")) return false;
    consumeToken(b, DOT);
    return true;
  }

  // range_exp | range_loc
  private static boolean call_expr_tail_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "call_expr_tail_1_2")) return false;
    boolean r;
    r = range_exp(b, l + 1);
  ...
  // DOTDOT expr
  private static boolean case_stmt_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_stmt_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, DOTDOT);
    r = r && expr(b, l + 1, -1);
  ...
  public static boolean constdef_constant(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_constant")) return false;
    if (!nextTokenIs(b, CONST_IDENT)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, CONST_IDENT);
    r = r && constdef_constant_1(b, l + 1);
    r = r && constdef_constant_2(b, l + 1);
    exit_section_(b, m, CONSTDEF_CONSTANT, r);
    return r;
  }

  // attributes?
  private static boolean constdef_constant_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_constant_1")) return false;
    attributes(b, l + 1);
    return true;
  }

  // [eq_expr_pin]
  private static boolean constdef_constant_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_constant_2")) return false;
    eq_expr_pin(b, l + 1);
    return true;
  }
  ...
  public static boolean constdef_declaration(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_declaration")) return false;
    if (!nextTokenIs(b, KW_CONSTDEF)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, CONSTDEF_DECLARATION, null);
    r = consumeToken(b, KW_CONSTDEF);
    r = r && type_name(b, l + 1);
    p = r; // pin = 2
    r = r && report_error_(b, constdef_declaration_2(b, l + 1));
    r = p && report_error_(b, constdef_declaration_3(b, l + 1)) && r;
    r = p && report_error_(b, constdef_declaration_4(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, LB)) && r;
    r = p && report_error_(b, constdef_list(b, l + 1)) && r;
  ...
  // interface_impl?
  private static boolean constdef_declaration_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_declaration_2")) return false;
    interface_impl(b, l + 1);
    return true;
  }

  // (COLON KW_INLINE? type?)?
  private static boolean constdef_declaration_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_declaration_3")) return false;
    constdef_declaration_3_0(b, l + 1);
    return true;
  }

  // COLON KW_INLINE? type?
  private static boolean constdef_declaration_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_declaration_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COLON);
    r = r && constdef_declaration_3_0_1(b, l + 1);
    r = r && constdef_declaration_3_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // KW_INLINE?
  private static boolean constdef_declaration_3_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_declaration_3_0_1")) return false;
    consumeToken(b, KW_INLINE);
    return true;
  }

  // type?
  private static boolean constdef_declaration_3_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_declaration_3_0_2")) return false;
    type(b, l + 1);
    return true;
  }

  // attributes?
  private static boolean constdef_declaration_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_declaration_4")) return false;
    attributes(b, l + 1);
    return true;
  }

  /* ********************************************************** */
  // constdef_constant (COMMA constdef_constant ?)* COMMA?
  public static boolean constdef_list(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_list")) return false;
    if (!nextTokenIs(b, CONST_IDENT)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = constdef_constant(b, l + 1);
    r = r && constdef_list_1(b, l + 1);
    r = r && constdef_list_2(b, l + 1);
    exit_section_(b, m, CONSTDEF_LIST, r);
    return r;
  }

  // (COMMA constdef_constant ?)*
  private static boolean constdef_list_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_list_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!constdef_list_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "constdef_list_1", c)) break;
    }
    return true;
  }

  // COMMA constdef_constant ?
  private static boolean constdef_list_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_list_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && constdef_list_1_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // constdef_constant ?
  private static boolean constdef_list_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_list_1_0_1")) return false;
    constdef_constant(b, l + 1);
    return true;
  }

  // COMMA?
  private static boolean constdef_list_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "constdef_list_2")) return false;
    consumeToken(b, COMMA);
    return true;
  }
  ...
  public static boolean ct_analyze(PsiBuilder b, int l) {
    ...
    r = consumeToken(b, KW_CT_EVAL);
    if (!r) r = consumeToken(b, KW_CT_REFLECT);
    if (!r) r = consumeToken(b, KW_CT_STRINGIFY);
    if (!r) r = consumeToken(b, KW_CT_EXPAND);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  private static boolean ct_assert_stmt_2_0(PsiBuilder b, int l) {
    ...
    r = consumeToken(b, COLON);
    r = r && constant_expr(b, l + 1);
    r = r && ct_assert_stmt_2_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (COMMA constant_expr)*
  private static boolean ct_assert_stmt_2_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_assert_stmt_2_0_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!ct_assert_stmt_2_0_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "ct_assert_stmt_2_0_2", c)) break;
    }
    return true;
  }

  // COMMA constant_expr
  private static boolean ct_assert_stmt_2_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_assert_stmt_2_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && constant_expr(b, l + 1);
  ...
  public static boolean ct_error_stmt(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, constant_expr(b, l + 1));
    r = p && report_error_(b, ct_error_stmt_2(b, l + 1)) && r;
    r = p && consumeToken(b, EOS) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // (COMMA constant_expr)*
  private static boolean ct_error_stmt_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_error_stmt_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!ct_error_stmt_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "ct_error_stmt_2", c)) break;
    }
    return true;
  }

  // COMMA constant_expr
  private static boolean ct_error_stmt_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_error_stmt_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && constant_expr(b, l + 1);
  ...
  public static boolean ct_switch_stmt(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, ct_switch_stmt_1(b, l + 1));
    r = p && report_error_(b, consumeToken(b, COLON)) && r;
    r = p && report_error_(b, ct_switch_body(b, l + 1)) && r;
  ...
  // constant_expr?
  private static boolean ct_switch_stmt_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_switch_stmt_1")) return false;
    constant_expr(b, l + 1);
    return true;
  }
  ...
  public static boolean enum_declaration(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, enum_declaration_5(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, LB)) && r;
  ...
  private static boolean enum_declaration_3_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = consumeToken(b, COLON);
    r = r && enum_declaration_3_0_1(b, l + 1);
    r = r && enum_declaration_3_0_2(b, l + 1);
    r = r && enum_declaration_3_0_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // KW_INLINE?
  private static boolean enum_declaration_3_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "enum_declaration_3_0_1")) return false;
    consumeToken(b, KW_INLINE);
    return true;
  }

  // type?
  private static boolean enum_declaration_3_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "enum_declaration_3_0_2")) return false;
    type(b, l + 1);
    return true;
  }

  // enum_param_list?
  private static boolean enum_declaration_3_0_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "enum_declaration_3_0_3")) return false;
  ...
  // COMMA?
  private static boolean fn_parameter_list_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "fn_parameter_list_2")) return false;
    consumeToken(b, COMMA);
    return true;
  }
  ...
  // attributes?
  private static boolean func_def_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "func_def_4")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  public static boolean generic_decl(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "generic_decl")) return false;
    if (!nextTokenIs(b, LT_OP)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, GENERIC_DECL, null);
  ...
  private static boolean global_decl_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_decl_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = global_decl_3_0_0(b, l + 1);
    r = r && global_decl_3_0_1(b, l + 1);
    r = r && global_decl_3_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (COMMA IDENT)+
  private static boolean global_decl_3_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_decl_3_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = global_decl_3_0_0_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!global_decl_3_0_0_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "global_decl_3_0_0", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // COMMA IDENT
  private static boolean global_decl_3_0_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_decl_3_0_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // generic_decl?
  private static boolean global_decl_3_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_decl_3_0_1")) return false;
    generic_decl(b, l + 1);
    return true;
  }

  // attributes?
  private static boolean global_decl_3_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_decl_3_0_2")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  private static boolean global_decl_3_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = global_decl_3_1_0(b, l + 1);
    r = r && global_decl_3_1_1(b, l + 1);
    r = r && global_decl_3_1_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // attributes?
  private static boolean global_decl_3_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_decl_3_1_1")) return false;
    attributes(b, l + 1);
    return true;
  }

  // eq_expr_pin?
  private static boolean global_decl_3_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_decl_3_1_2")) return false;
    eq_expr_pin(b, l + 1);
    return true;
  }
  ...
  static boolean keyword_list(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeToken(b, KW_CT_EXEC);
  ...
  // attributes?
  private static boolean macro_definition_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "macro_definition_6")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  private static boolean param_decl_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = param_decl_1_0(b, l + 1);
    if (!r) r = param_decl_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean param_decl_1_0(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, EQ, ELLIPSIS);
    exit_section_(b, m, null, r);
    return r;
  }

  // [eq_expr_pin]
  private static boolean param_decl_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "param_decl_1_1")) return false;
    eq_expr_pin(b, l + 1);
    return true;
  }
  ...
  public static boolean struct_declaration(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, struct_declaration_4(b, l + 1)) && r;
  ...
  static boolean struct_member_declaration_3(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = struct_member_declaration_3_0(b, l + 1);
    p = r; // pin = 1
  ...
  // KW_STRUCT | KW_UNION
  private static boolean struct_member_declaration_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "struct_member_declaration_3_0")) return false;
    boolean r;
    r = consumeToken(b, KW_STRUCT);
    if (!r) r = consumeToken(b, KW_UNION);
    return r;
  ...
  // KW_CT_EXPAND grouped_expr
  private static boolean top_level_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_level_6")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, KW_CT_EXPAND);
    r = r && grouped_expr(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  public static boolean type_decl(PsiBuilder b, int l) {
    ...
    if (!r) r = constdef_declaration(b, l + 1);
  ...
  /* ********************************************************** */
  // KW_TYPEDEF type_name interface_impl? generic_decl? attributes? EQ KW_INLINE? typedef_type EOS
  public static boolean typedef_decl(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, typedef_decl_4(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, EQ)) && r;
    r = p && report_error_(b, typedef_decl_6(b, l + 1)) && r;
    r = p && report_error_(b, typedef_type(b, l + 1)) && r;
    r = p && consumeToken(b, EOS) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  ...
  // attributes?
  private static boolean typedef_decl_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "typedef_decl_4")) return false;
    attributes(b, l + 1);
    return true;
  }

  // KW_INLINE?
  private static boolean typedef_decl_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "typedef_decl_6")) return false;
    consumeToken(b, KW_INLINE);
    return true;
  }
  ...
  private static boolean typedef_type_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "typedef_type_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, KW_FN);
    r = r && optional_type(b, l + 1);
  ...
  private static boolean unary_op_11(PsiBuilder b, int l) {
    ...
    r = r && type(b, l + 1);
    r = r && consumeToken(b, RP);
    r = r && unary_op_11_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // !LB
  private static boolean unary_op_11_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "unary_op_11_3")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_);
    r = !consumeToken(b, LB);
    exit_section_(b, l, m, r, false, null);
  ...
  // attributes?
  private static boolean var_decl_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_decl_1_0_1")) return false;
    attributes(b, l + 1);
    return true;
  }
  ...
  public static boolean expr_0(PsiBuilder b, int l, int g) {
    ...
    while (true) {
      ...
      else if (g < 7 && consumeTokenSmart(b, ELVIS)) {
        r = expr(b, l, 6);
        exit_section_(b, l, m, BINARY_EXPR, r, true, null);
      }
      else if (g < 8 && consumeTokenSmart(b, OPTELSE)) {
        r = expr(b, l, 7);
        exit_section_(b, l, m, BINARY_EXPR, r, true, null);
      }
      else if (g < 9 && bit_bin_op(b, l + 1)) {
        r = expr(b, l, 9);
        exit_section_(b, l, m, BINARY_EXPR, r, true, null);
      }
      else if (g < 10 && shift_bin_op(b, l + 1)) {
        r = expr(b, l, 10);
        exit_section_(b, l, m, BINARY_EXPR, r, true, null);
      }
      else if (g < 11 && mult_bin_op(b, l + 1)) {
        r = expr(b, l, 11);
        exit_section_(b, l, m, BINARY_EXPR, r, true, null);
      }
      else if (g < 13 && call_expr_tail(b, l + 1)) {
        r = true;
  ...
  private static boolean ternary_expr_0(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeTokenSmart(b, CT_TERNARY);
    return r;
  }
  ...
  public static boolean compound_init_expr(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, COMPOUND_INIT_EXPR, r);
    return r;
  }
  ...
  public static boolean enum_access_expr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "enum_access_expr")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ENUM_ACCESS_EXPR, "<enum access expr>");
    r = base_type(b, l + 1);
    r = r && consumeTokensSmart(b, 0, DOT, CONST_IDENT);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  private static boolean type_expr_3(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NOT_);
    r = !consumeTokenSmart(b, KW_CT_EVAL);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // !QUESTION
  private static boolean type_expr_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "type_expr_4")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_);
    r = !consumeTokenSmart(b, QUESTION);
    exit_section_(b, l, m, r, false, null);
  ...
  public static boolean ct_arg_expr(PsiBuilder b, int l) {
    ...
    if (!nextTokenIsSmart(b, KW_CT_VAARG)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokenSmart(b, KW_CT_VAARG);
    r = r && ct_arg_expr_1(b, l + 1);
    exit_section_(b, m, CT_ARG_EXPR, r);
    return r;
  }
  ...
  // range_exp | range_loc
  private static boolean ct_arg_expr_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ct_arg_expr_1_0_1")) return false;
    boolean r;
    r = range_exp(b, l + 1);
    if (!r) r = range_loc(b, l + 1);
    return r;
  ...
  public static boolean ct_analyze_expr(PsiBuilder b, int l) {
    ...
    p = r;
    r = p && expr(b, l, 13);
    exit_section_(b, l, m, CT_ANALYZE_EXPR, r, p, null);
    return r || p;
  }
